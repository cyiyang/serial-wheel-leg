...
labels = ["plane", "car", "ship"] #类名称，按照label.txt顺序填写
anchor = (9.50, 4.00, 7.97, 5.06, 9.69, 4.81, 7.59, 6.58, 9.36, 6.02) # anchors,使用anchor.txt中第二行的值

kpu = KPU()
# 从sd或flash加载模型
kpu.load_kmodel('/sd/KPU/train_model_and_use/det.kmodel')
#kpu.load_kmodel(0x300000, 584744)
kpu.init_yolo2(anchor, anchor_num=(int)(len(anchor)/2), img_w=320, img_h=240, net_w=320 , net_h=240 ,layer_w=10 ,layer_h=8, threshold=0.1, nms_value=0.3, classes=len(labels))
